    ...
    "/notes/": [
      {
        text: "开发笔记",
        items: [
          { text: "ip地址获取/VPN代理检测", link: "/notes/detect-ip-vpn" }, // 确保文件路径小写
          { text: "axios最全二次封装", link: "/notes/axios-enclose" },
          { text: "vue3+element-plus+ts+vue-i18n国际化教程", link: "/notes/vue3-multi-language-program" },
          { text: "自动化翻译的JavaScript程序", link: "/notes/baidu-translation" },
          { text: "uniapp集成cloudflare turnstile人机验证", link: "/notes/cloudflare-turnstile" },
        ],
      },
      {
        text: "框架与工具",
    ...
    "/projects/": [
      {
        text: "项目列表",
        items: [
          { text: "注册接口实现", link: "/projects/registration-api" },
        ],
      },
    ],
  };
